...
from dashboard.api import nova, cinder, network
from dashboard.api.base import is_service_enabled, QuotaSet
...
def _get_quota_data(request, method_name, disabled_quotas=None,
    ...
    quotasets.append(getattr(nova, 'nova_'+method_name)(request, tenant_id))
    qs = QuotaSet()
    if disabled_quotas is None:
        disabled_quotas = get_disabled_quotas(request)
    if 'volumes' not in disabled_quotas:
        quotasets.append(getattr(cinder, 'cinder_'+method_name)(request, tenant_id))
