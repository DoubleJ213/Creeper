...
(function($){
	$.fn.jTable = function(options){
		return this.each(function(){
		 	...
		 	var tlength = $table.width() || $("#container").width() - 2;
            if (tlength <= 100) {
                tlength = $("#container").width() - 2;
            }
            //update by zhaolei
            if (tlength>1600)
            {
			...
			for(var i = 0, l = oldThs.size(); i < l; i++) {
                ...
                if (width > 100 && i !=  oldThs.size()-1){
                    width  = 100
                }else if (width < 40 && i ==  oldThs.size()-1)
                {
                    width = 50;
                }
                if($th[0].id == "volume_actionId"){
			...
			tbody.wrap("<div class='gridScroller'" + layoutStr + " style='width:" + ($tc.width() || $("#container").width() - 2) + "px;'><div class='gridTbody'><table style='width:" + (tlength - 20) + "px;'></table></div></div>");
