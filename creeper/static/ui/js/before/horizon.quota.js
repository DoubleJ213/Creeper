...
horizon.Quota = {
    ...
    _attachInputHandlers:function () {
        ...
        if(this.user_value_form_inputs){
            $(this.user_value_form_inputs).each(function (index, element) {
                $(element).on('change', function (evt) {
                    ...
                    var integers_in_input_val = $(evt.target).val();
                    var integers_in_input = integers_in_input_val == 'max' ? "100" : integers_in_input_val == 'large'
                        ? "50" : integers_in_input_val == 'medium' ? "25" : integers_in_input_val == 'small' ? "10" : "0"
                    var user_integer;
                    integers_in_input=integers_in_input.match(/\d+/g)
